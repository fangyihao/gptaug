...
def parse_arguments():
    ...
    parser.add_argument("--boost_method", type=str, default="F-10", help="The data augmentation method for training.")
    
    parser.add_argument("--boost_start_score", type=float, default=0.0, help="The minimum evaluation score to start data augmentation.")
